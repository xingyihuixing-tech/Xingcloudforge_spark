...
const App: React.FC = () => {
  ...
  // 可拖拽AI星星按钮
  const { starRef, handleDragStart: handleStarDragStart, handleTouchStart: handleStarTouchStart, isCustomPosition: isStarCustomPos, wasDragged } = useDraggableStar(xingConfig, setXingConfig);
